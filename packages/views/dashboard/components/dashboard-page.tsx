...
function Leaderboard({
  ...
  // Window totals across every agent — the leaderboard footer. Deliberately
  // over `rows`, not `visibleRows`: the footer is the window total, so it must
  // not change when the top-10 cap is expanded.
