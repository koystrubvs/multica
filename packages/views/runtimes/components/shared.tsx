...
export function KpiCard({
  ...
  return (
    <div className="flex min-w-0 flex-col gap-2 p-5">
      ...
      {/* Local: long values (₽-суммы) must wrap and step down on narrow cards
          instead of overflowing — keep the responsive pair and leading-tight. */}
      <div className={`break-words text-display-sm font-semibold leading-tight tabular-nums sm:text-display ${valueClass}`}>
        {value}
      </div>
      {hint != null && (
