		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api/issues", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Post("/billing/charge/confirm", h.ConfirmIssueBillingCharge)
					r.Post("/billing/charge/void", h.VoidIssueBillingCharge)
					r.Post("/billing/charge/adjust", h.AdjustIssueBillingCharge)
