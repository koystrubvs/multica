...
RETURNING id, autopilot_id, trigger_id, source, status, issue_id, task_id, triggered_at, completed_at, failure_reason, trigger_payload, result, created_at, squad_id, pending_runtime_id, planned_at, webhook_delivery_id
`
...
SELECT id, autopilot_id, trigger_id, source, status, issue_id, task_id, triggered_at, completed_at, failure_reason, trigger_payload, result, created_at, squad_id, pending_runtime_id, planned_at, webhook_delivery_id FROM autopilot_run
WHERE id = $1
`
...
SELECT r.id, r.autopilot_id, r.trigger_id, r.source, r.status, r.issue_id, r.task_id, r.triggered_at, r.completed_at, r.failure_reason, r.trigger_payload, r.result, r.created_at, r.squad_id, r.pending_runtime_id, r.planned_at, r.webhook_delivery_id, a.workspace_id AS autopilot_workspace_id,
